...
func _ready():
	...
	area_descs["FOREST_01"] = "I am dimly aware of strange life all around me, but the angry snarl of a not so distant beast wrenches me from my stupor. I am in a dense forest, surrounded by the menacing shadows of twisted trees. As the savage sounds grow to a chorus and start to draw closer, I know that I am no longer safe here."
	...
	area_descs["FOREST_03"] = "My heart hammers my chest as the blood roars through my veins. I can see fractured moonlight through the trees ahead, but the thundering hoofbeats tell me that the beasts are nearly upon me."
	area_descs["EXT_DOOR"] = "I throw myself into the clearing at the last moment. Even though I can still feel hateful eyes at my back, it seems that my pursuers will not follow me out of the denser part of the forest. But my relief is quickly overshadowed by the building that looms before me. A voice from my own forgotten history tells me that it has been constructed in the style of the ancient lemurians. I dare not try to explain its presence here, far from the shifting sands. Perhaps it is the fear of this monument to a forgotten age that keeps the beasts of the forest at bay. Even still, I would feel more comfortable with that heavy door between me and the night."
	...
	area_descs["ANTE_W_BRAZIER"] = "..."
	area_descs["ANTE_E_BRAZIER"] = "..."
	...
	area_hints["FOREST_01"] = [
		...
		"I should try typing 'run'."
	]
	area_hints["FOREST_02"] = [
		2,
		"I have no choice but to run.",
		"I am not out of the forest yet. I need to keep running.",
		"I should try typing 'run'."
	]
	...
	area_hints["EXT_DOOR"] = [
		...
		"If I have a closer look at the locked door, then I might find a clue.",
		"I should try typing 'look door'.",
		"Something in my inventory might help me unlock the door.",
		"I should try typing 'open inventory'.",
		"There is a page in my inventory. Perhaps I should read it?",
		"I should try typing 'read page'.",
		"The door is still closed, but the page from my inventory mentions 'asking nicely'. Maybe it is as simple as saying please?",
		"I should try typing 'say please' and then 'open door'.",
	]
	area_hints["ANTE_CAMP"] = [
		2,
		"I now realize that I have been moving as though in a deep trance. Taking a few deep breaths, I force my limbs to relax. (I can now use the mouse to look around, WASD to move, and left-click to interact.)"
	]
	...
	area_fails["FOREST_01"] = [
		...
		[
			"NORTH",
			"The only direction I am concerned with right now is the one that takes me away from my pursuers. I need to RUN."
		],
		[
			"SOUTH",
			"The only direction I am concerned with right now is the one that takes me away from my pursuers. I need to RUN."
	...
	item_descs["DOOR"] = "There are telltale signs of the crude tools once used to cut this great stone door, but I can find no evidence of a lock or hinges. As I inspect more closely, my gaze is drawn inexplicably to the green stone in the center. A hush falls over the forest, and you cannot help but feel that the stone is... Listening... There is a familiarity to this scene that I cannot explain, and I suspect that I may have something in my inventory that might help."
	...
	item_descs["UNLITTORCH"] = "There are flakes of burnt parchment throughout the area, and I suspect this torch to be the culprit. It is not currently lit."
