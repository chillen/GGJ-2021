...
func _ready():
	...
	area_descs["FOREST_03"] = "my heart hammers my chest as the blood roars through my veins. I can see fractured moonlight through the trees ahead, but the thundering hoofbeats tell me that the beasts are nearly upon myself."
	area_descs["EXT_DOOR"] = "I throw myself into the clearing at the last moment. Even though I can still feel hateful eyes at my back, it seems that my pursuers will not follow me out of the denser part of the forest. But my relief is quickly overshadowed by the building that looms before me. A voice from my own forgotten history tells me that it has been constructed in the style of the ancient lemurians. I do not dare to try to explain its presence here, far from the shifting sands. Perhaps it is the fear of this monument to a forgotten age that keeps the beasts of the forest at bay. Even still, I would feel more comfortable with that heavy door between myself and the night."
	...
	area_hints["FOREST_03"] = [
		2,
		"I have no choice but to run.",
		"I've almost escaped the forest, but I need to keep running.",
		"Try typing 'run'."
	]
	area_hints["EXT_DOOR"] = [
		2,
		"But first I need to try and open it.",
		"If I take a closer look at the locked door I might find a clue.",
