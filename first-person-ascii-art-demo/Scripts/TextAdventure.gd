...
func _ready():
	...
	area_descs["ANTE_CAMP"] = "The light and warmth exhaled from the antechamber before you banishes the chill in the night air. Much of the detail on the statue in the middle of the room has been consumed by time, but you are still able to recognize the winged being that was depicted here. Faint wisps of smoke rise from the torches on either side, suggesting that they were hastily extinguished only a short time ago. Not wanting to disturb the site, you make your way towards one corner of the room, suddenly finding yourself standing in the remains of a small basecamp."
